...
impl Appearance {
    ...
    fn create_styling_section_box(application_provider: &ApplicationProvider) -> GTKBox {
        ...
        let inner_gap_spin_button_change = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_inner_gab(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_inner_gab(),
            increment_value: 0.1,
        ...
        let outer_gap_spin_button_change = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_outer_gab(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_outer_gab(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let border_size_spin_button_change = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_border_size(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_border_size(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
    ...
    fn create_decorations_section_box(application_provider: &ApplicationProvider) -> GTKBox {
        ...
        let rounding_spin_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_rounding(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_rounding(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let rounding_spin_power_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_rounding_power(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_rounding_power(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let active_opacity_spin_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_active_opacity(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_active_opacity(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let inactive_opacity_spin_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_inactive_opacity(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_inactive_opacity(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let shadow_range_spin_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_shadow_range(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_shadow_range(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let shadow_render_power_spin_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_shadow_render_power(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_shadow_render_power(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let blur_size_spin_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_appearance_blur_size(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_appearance_blur_size(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let blur_passes_spin_button_changed_callback = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_appearance_blur_passes(spin_button.value() as usize);
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_appearance_blur_passes() as f64,
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
        ...
        let blur_vibrancy_spin_button_change = move |spin_button: &GTKSpinButton| {
            appearance_provider_clone.borrow_mut().set_appearance_blur_vibrancy(spin_button.value());
        };
        ...
        let state = SpinButtonState {
            ...
            min_value: 0.0,
            max_value: 100.0,
            current_value: appearance_provider.borrow().get_appearance_blur_vibrancy(),
            increment_value: 0.1,
            page_increment_value: 1.0,
            page_size: 0.0,
            climb_rate: 1.0,
    ...
    fn create_layouts_section_box(application_provider: &ApplicationProvider) -> GTKBox {
        ...
        let layout_input_change = move |entry: &Entry| {
            appearance_provider_clone.borrow_mut().set_layout(entry.text().to_string());
        };
        ...
        let master_status_input_change = move |entry: &Entry| {
            appearance_provider_clone.borrow_mut().set_master_status(entry.text().to_string());
        };
